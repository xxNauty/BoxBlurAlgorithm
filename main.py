...
def blur(path_to_image : str) -> None:
    os.system('cls' if os.name == 'nt' else 'clear')

    print("Processed image:", os.path.basename(path_to_image))
    ...
    ) if os.getenv("ADD_DATETIME_TO_FILENAME") == "True" else ""
    intensity_of_blur = (
            "_intensity-" +
            intensity
    ) if os.getenv("ADD_INTENSITY_TO_FILENAME") == "True" else ""
